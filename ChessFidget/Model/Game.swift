...
/// Represents a chess game between a human player (the user) and the computer.  The computer's moves are either randomly selected or generated by a backend engine.
class Game {
