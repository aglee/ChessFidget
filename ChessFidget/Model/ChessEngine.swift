...
class ChessEngine: ProcessWrapperDelegate {
	/// The game in which we're participating.
	weak var game: Game?
	...
	/// Launches the chess engine, tells it to start a game.
	/// - parameter game: The game we're associated with.
	/// - parameter makeFirstMove: If true, we make White's first move.
	...
	/// - parameter moveString: Should be in algebraic notation like "d2d4" or "a7a8q".
