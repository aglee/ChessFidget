...
// 2. the coordinates are Cartesian (y increases upward).
...
/// A vector in 2D with integer coordinates.  Tuple notation may help with clarity in some cases.
typealias VectorXY = (dx: Int, dy: Int)
